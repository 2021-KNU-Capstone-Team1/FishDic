...
<p align="center"><b><u>그림 3) 쭈꾸미와 낙지</u></b></p>
    ...
    1-1) 낚시를 하거나 어류를 구매하는 경우 전문가가 아닌 일반인들은 위 그림 1), 그림 2), 그림3) 과 같이 각 어류의 외형을 보고 구분하는 것은 어려운 일이다.
...
<b>2. 목표 설정</b>
    ...
    2-1) 이에 따라 우리는 어류에 대한 이름, 학명, 생물분류, 개통분류, 서식지, 분포, 형태, 몸길이, 이미지, 금어기 정보를 제공하고,
...
<p align="center"><b><u>그림 4) 사용 사례 분석</u></b></p>
    ...
    3-1) 작동 방식은 위 그림 4) 사용 사례 분석과 같다.
    3-2) 사용자는 본 솔루션을 통해 어류 정보(전체 어류 정보 조회 혹은 이달의 금어기 정보)를 조회 할 수 있으며, 어류 이름 검색을 추가적으로 제공하여, 어류 이름에 해당되는 어류의 정보를 조회 할 수 있다.
