 ...
 * $_FILES[’form_name’][’error’] - 파일업로드 작업시 발생한 에러코드 (‘0′ 은 성공을 의미하고 나머지는 실패)
...
{
    if(move_uploaded_file($_FILES['feedback_data']['tmp_name'], $target_dir)) //임시 디렉토리에서 목적지 디렉토리로 이동
        echo "success";
    else
        echo "fail";
}
