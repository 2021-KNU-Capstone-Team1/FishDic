...
public class FishDetailActivity extends Activity {
    ImageButton fishDetali_back_imageButton; //뒤로 가기 버튼
    ...
    {
        fishDetali_back_imageButton = (ImageButton) findViewById(R.id.fishDetail_back_imageButton);

        fishDetali_back_imageButton.setOnClickListener(v ->
        {
            onBackPressed();
        });
    }
